<script type="text/javascript">
	!function(s){
		"use strict";
		var r=function(){};
		r.prototype.respChart=function(r,o,a,e){var t=r.get(0).getContext(""),n=s(r).parent();
			function i(){r.attr("width",s(n).width())
			;switch(o){
				case"Line":
				new Chart(t,{
					type:"line",
